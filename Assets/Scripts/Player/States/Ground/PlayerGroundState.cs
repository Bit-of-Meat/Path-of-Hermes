    ...
    public class PlayerGroundState : StateBase<PlayerStates> {
        ...
        public override void Init() {
            _stateMachine.AddState(PlayerStates.Idle, new PlayerIdleState(_controller))
                        ...
                        .AddTransition(PlayerStates.Run, PlayerStates.Crouch, (_) => _controller.Input.IsCrouch && _controller.Speed < _controller.SprintSpeed)
                        .AddTransition(PlayerStates.Run, PlayerStates.Slide, (_) => _controller.Input.IsCrouch && _controller.Speed >= _controller.SprintSpeed)

                        .AddTransition(PlayerStates.Slide, PlayerStates.Crouch, (_) => _controller.Speed <= _controller.CrouchSpeed)
                        .AddTransition(PlayerStates.Slide, PlayerStates.Idle, (_) => !_controller.Input.IsCrouch)
